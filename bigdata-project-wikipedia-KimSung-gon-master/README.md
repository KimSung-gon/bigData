...
![Image here](picture/2_1.png)
![Image here](picture/2_2.png)
...
![Image here](picture/result1.png)
...
Inverted Index can reduce full data to primary index. This can reduce the amount of data, so it can reduce the time of computing. So the time performance between results of 1 and (2,3) is big. And reduceByKey is more faster than usingIndex because this reduce at each partition.
